...
def send_daily_report():
    ...
    message += "━━━━━━━━━━━━━━━━━━\n"
    message += f"📥 إجمالي التوريدات: {supply_count} عملية ({int(supply_qty)} قطعة)\n"
    message += f"📤 إجمالي الصرفيات: {withdraw_count} عملية ({int(withdraw_qty)} قطعة)\n"
    if delete_count > 0:
